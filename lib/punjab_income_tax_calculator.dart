...
class PunjabIncomeTaxCalculator extends StatefulWidget {
  @override
  _PunjabTaxCalculatorState createState() => _PunjabTaxCalculatorState();
}

class _PunjabTaxCalculatorState extends State<PunjabIncomeTaxCalculator> {
            ...
            children: [
              Center(
                child: Padding(
                  ...
                  child: Text(
                    'Punjab Tax on Agricultural Income Calculator $_selectedYear',
                    style: TextStyle(
                      fontSize: 36,
              ...
              Center(
                child: Padding(
                  padding: const EdgeInsets.only(top: 20.0),
                  child: Text(
                    'This is the latest Punjab Agricultural income calculator as per $_selectedYear budget presented by the government of Pakistan.',
                    style: TextStyle(
                      fontSize: 18,
                      fontWeight: FontWeight.bold,
                      color: Colors.green[900],
                ...
                child: Column(
                  children: [
                    Container(
                      ...
                      child: Center(
                        child: Text(
                          "Punjab Tax On Agricultural Income",
                          style: TextStyle(
                            fontSize: 22,
                            fontWeight: FontWeight.bold,
                            color: Colors.white,
  ...
  double _calculateTax23to24(double amount) {
    ...
    if (amount > 0 && amount < 400000) {
      ...
      taxAmount = (amount - 400000) * 0.00 + 1000;
    } else if (amount >= 800000 && amount < 1200000) {
      taxAmount = (amount - 800000) * 0.00 + 2000;
