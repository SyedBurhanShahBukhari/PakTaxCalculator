...
class BalochistanIncomeTaxCalculator extends StatefulWidget {
  @override
  _BalochistanTaxCalculatorState createState() => _BalochistanTaxCalculatorState();
}

class _BalochistanTaxCalculatorState extends State<BalochistanIncomeTaxCalculator> {
  final TextEditingController _incomeController = TextEditingController();
  final NumberFormat numberFormat = NumberFormat('#,##0.00'); // For formatted output
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Balochistan Agri. Income Tax Calculator',
          style: TextStyle(
            color: Colors.white,
          ),
        ),
            ...
            children: [
              Center(
                child: Padding(
                  ...
                  child: Text(
                    'Balochistan Tax on Agricultural Income Calculator $_selectedYear',
                    style: TextStyle(
                      fontSize: 36,
              ...
              Center(
                child: Padding(
                  padding: const EdgeInsets.only(top: 20.0),
                  child: Text(
                    'This is the latest Balochistan Agricultural income calculator as per $_selectedYear budget presented by the government of Pakistan.',
                    style: TextStyle(
                      fontSize: 18,
                      fontWeight: FontWeight.bold,
                      color: Colors.green[900],
                ...
                child: Column(
                  children: [
                    Container(
                      ...
                      child: Center(
                        child: Text(
                          "Balochistan Tax On Agri. Income",
                          style: TextStyle(
                            fontSize: 22,
                            fontWeight: FontWeight.bold,
                            color: Colors.white,
                    ...
                    Card(
                      ...
                      child: Column(
                        children: [
                          _buildTableRow("Agri. Income", "${numberFormat.format(_annualIncome)} PKR"),
                          Divider(height: 0.5, color: Colors.green),
                          _buildTableRow("Tax on Agri. Income", "${numberFormat.format(_incomeTax)} PKR", isLast: true),
                        ],
                      ),
                    ),
                  ],
